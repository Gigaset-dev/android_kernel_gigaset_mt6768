...
//drv-fix Antutu detects a screen size of 6.81, which does not conform to the product definition of 6.7-pengzhipeng-20230607-start
#define PHYSICAL_WIDTH              69552
#define PHYSICAL_HEIGHT             155330
//drv-fix Antutu detects a screen size of 6.81, which does not conform to the product definition of 6.7-pengzhipeng-20230607-end
#define DATA_RATE                   250*2
#define HSA                         8
#define HBP                         92
#define VSA                         4
#define VBP                         8
