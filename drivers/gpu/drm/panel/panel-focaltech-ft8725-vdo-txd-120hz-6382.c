...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	//TCON
	lcm_dcs_write_seq_static(ctx, 0x00, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00 ,0x49 ,0x00 ,0x28 ,0x00 ,0x12);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00 ,0x49 ,0x00 ,0x28 ,0x00 ,0x12);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xA0);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00 ,0x5D ,0x00 ,0x28 ,0x00 ,0x12);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xB0);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00 ,0xC9 ,0x00 ,0x28 ,0x12);
	udelay(100);
	...
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00 ,0x92 ,0x00 ,0x28 ,0x00 ,0x12);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xA3);
	lcm_dcs_write_seq_static(ctx, 0xC1, 0x00, 0x54, 0x00 ,0x32 ,0x00 ,0x02);
	udelay(100);
	...
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x01, 0x81 ,0xFF ,0xFF ,0x00 ,0xC8 ,0x00 ,0xCD ,0x00 ,0x6E ,0x00 ,0x64 ,0x00 ,0x8C ,0x00,0x87);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x00 ,0xB7 ,0x10 ,0xAE ,0x00 ,0xB7 ,0x80 ,0xFF ,0xFF ,0x00 ,0x0C ,0x1C ,0x0E ,0x0A ,0x0A);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xA0);
	...
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x05 ,0x01 ,0xCA ,0x02 ,0xFB ,0x02 ,0xFB ,0x00 ,0x00 ,0x00 ,0x00);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xF1);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x28 ,0x1E ,0x14 ,0x00 ,0xE9 ,0x00 ,0xE9 ,0x00 ,0xE9);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xB0);
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x00 ,0x00 ,0xBE ,0xC2);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0xB5);
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x05 ,0x05 ,0x8C ,0x90);
	udelay(100);
	...
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x00 ,0x00 ,0x84 ,0x88 ,0x05 ,0x05 ,0x43 ,0x47);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00, 0x70);
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x00 ,0x00 ,0x69 ,0x6D ,0x05 ,0x05 ,0x19 ,0x1D);
	udelay(100);
	//Qsync Detect
	lcm_dcs_write_seq_static(ctx, 0x00, 0xD1);
	...
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x0A ,0x28 ,0x0A ,0x27 ,0x0A ,0x27 ,0x0A ,0x27 ,0x0A ,0x27 ,0x0A ,0x27);
	udelay(100);
	//OSC
	lcm_dcs_write_seq_static(ctx, 0x00, 0x80);
	...
	//power VDD=1.275V LVDSVDD=1.25V
	...
	//STV1 & STV2 Setting
	lcm_dcs_write_seq_static(ctx, 0x00,0x80);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x81,0x00,0x02,0x8F,0x00,0x00,0x00,0x00);
	udelay(100);
	//VEND Setting
	lcm_dcs_write_seq_static(ctx, 0x00,0x90);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x80,0x00,0x04,0x8F);
	udelay(100);
	//CKV1-3 setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x00,0x04,0x00,0x04,0x8F,0x01,0x05,0x00,0x04,0x8F,0x02,0x06,0x00,0x04,0x8F);
	udelay(100);
	//CKV4-5 setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x03,0x04,0x00,0x04,0x8F,0x04,0x05,0x00,0x04,0x8F);
	udelay(100);
	//CKV width setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xE0);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x44,0x44,0x40,0x00);
	udelay(100);
	//Rst1 Setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xE8);
	lcm_dcs_write_seq_static(ctx, 0xC2,0x0B,0x00,0x05,0x03,0x02,0x8a,0x00,0x00);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xD0);
	lcm_dcs_write_seq_static(ctx, 0xC3,0x35,0x00,0x00,0x00,0x35,0x00,0x00,0x00,0x35,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xE0);
	lcm_dcs_write_seq_static(ctx, 0xC3,0x35,0x00,0x00,0x00,0x35,0x00,0x00,0x00,0x35,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	udelay(100);
	//ENMODE POWER OFF
	lcm_dcs_write_seq_static(ctx, 0x00,0x80);
	lcm_dcs_write_seq_static(ctx, 0xcb,0x00,0x01,0x01,0x01,0xfd,0xfd,0x00, 0xfD,0x03,0xfE,0xfd,0x01,0x00,0x00,0x00,0x03);
	udelay(100);
	//ENMODE POWER ON
	lcm_dcs_write_seq_static(ctx, 0x00,0x90);
	lcm_dcs_write_seq_static(ctx, 0xcb,0x00,0x00,0x0F,0x00,0x0C,0x0C,0x00, 0x00,0xff,0xFC,0x00,0x7f,0x00,0x00,0x00,0xFF);
	udelay(100);
	//skip & powr on1 enmode setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
	lcm_dcs_write_seq_static(ctx, 0xCB,0x00,0xC0,0x00,0x00, 0x00,0x00,0x00,0x00);
	udelay(100);
	//power off blank enmode setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
	lcm_dcs_write_seq_static(ctx, 0xCB,0x50,0xD1,0xE5,0x00);
	udelay(100);
	//power on blank enmode setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xC0);
	lcm_dcs_write_seq_static(ctx, 0xCB,0x40,0x00,0xF1,0x00);
	udelay(100);
	//power on blank enmode setting
	...
	//u2d_L
	lcm_dcs_write_seq_static(ctx, 0x00,0x80);
	lcm_dcs_write_seq_static(ctx, 0xCC,0x26,0x22,0x22,0x24,0x25,0x22,0x02,0x0A,0x09,0x08,0x07,0x06,0x18,0x18,0x17,0x17);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0x90);
	lcm_dcs_write_seq_static(ctx, 0xCC,0x16,0x16,0x1B,0x1B,0x1A,0x1A,0x19,0x19);
	udelay(100);
	//d2u_L
	lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
	lcm_dcs_write_seq_static(ctx, 0xCC,0x26,0x22,0x22,0x24,0x25,0x22,0x02,0x06,0x07,0x08,0x09,0x0A,0x18,0x18,0x17,0x17);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
	lcm_dcs_write_seq_static(ctx, 0xCC,0x16,0x16,0x1B,0x1B,0x1A,0x1A,0x19,0x19);
	udelay(100);
	//u2d_R
	lcm_dcs_write_seq_static(ctx, 0x00,0x80);
	lcm_dcs_write_seq_static(ctx, 0xCD,0x26,0x22,0x22,0x24,0x25,0x22,0x02,0x0A,0x09,0x08,0x07,0x06,0x18,0x18,0x17,0x17);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0x90);
	lcm_dcs_write_seq_static(ctx, 0xCD,0x16,0x16,0x1B,0x1B,0x1A,0x1A,0x19,0x19);
	udelay(100);
	//d2u_R
	lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
	lcm_dcs_write_seq_static(ctx, 0xCD,0x26,0x22,0x22,0x24,0x25,0x22,0x02,0x06,0x07,0x08,0x09,0x0A,0x18,0x18,0x17,0x17);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
	lcm_dcs_write_seq_static(ctx, 0xCD,0x16,0x16,0x1B,0x1B,0x1A,0x1A,0x19,0x19);
	//==============================================
	...
	lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0x02,0x00,0x01,0x0F,0x0F,0x0F,0x03);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0x96);//IDLE
	lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0x00,0x00,0x02,0x11,0x11,0x11,0x04);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xA6);//LPF
	lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0x00,0x00,0x03,0x16,0x16,0x16,0x01);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xA3);//PER_DMY
	lcm_dcs_write_seq_static(ctx, 0xCE,0x00,0x02,0x00,0x01,0x0F,0x03);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0xB3);//POS_DMY
	lcm_dcs_write_seq_static(ctx, 0xCE,0x00,0x02,0x00,0x01,0x0F,0x03);
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0x76);//FIFO
	lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0x00,0x00,0x01,0x29,0x29,0x29,0x07);
	udelay(100);
	//CKH_dummy
	lcm_dcs_write_seq_static(ctx, 0x00,0x82);
	lcm_dcs_write_seq_static(ctx, 0xa7,0x10,0x00);
	udelay(100);
	...
	//vgh=10.5V
	lcm_dcs_write_seq_static(ctx, 0x00,0x93);
	lcm_dcs_write_seq_static(ctx, 0xC5,0x32);
	...
	//vgho1=9.5V, vglo1=-7V setting
	lcm_dcs_write_seq_static(ctx, 0x00,0xB6);
	lcm_dcs_write_seq_static(ctx, 0xC5,0x28,0x28,0x0F,0x0F);
	udelay(100);
	//GVDDP, GVDDN=±5.1V
	lcm_dcs_write_seq_static(ctx, 0x00,0x00);
	lcm_dcs_write_seq_static(ctx, 0xD8,0x2D,0x2D);
	udelay(100);
	//VCOM=-0.2V
	lcm_dcs_write_seq_static(ctx, 0x00,0x00);
	...
	udelay(100);
	lcm_dcs_write_seq_static(ctx, 0x00,0x80);
	lcm_dcs_write_seq_static(ctx, 0xA4,0xC2);

	//vgho1/vglo1 power on/off
	lcm_dcs_write_seq_static(ctx, 0x00,0x82);
	...
	lcm_dcs_write_seq_static(ctx, 0x00,0x92);//VGH clamp off
	lcm_dcs_write_seq_static(ctx, 0xC5,0x00);

	lcm_dcs_write_seq_static(ctx, 0x00,0xA0);//VGH pump stop with charge phase @TP term
	lcm_dcs_write_seq_static(ctx, 0xC5,0x40);

	lcm_dcs_write_seq_static(ctx, 0x00,0x98);//VGH pump stop with charge phase @TP term
	lcm_dcs_write_seq_static(ctx, 0xC5,0x24);

	lcm_dcs_write_seq_static(ctx, 0x00,0xA1);//VGL pump stop with pull phase @TP term
	lcm_dcs_write_seq_static(ctx, 0xC5,0x40);

	lcm_dcs_write_seq_static(ctx, 0x00,0x9D);//VGL pump line rate 1/4H
	lcm_dcs_write_seq_static(ctx, 0xC5,0x24);

	lcm_dcs_write_seq_static(ctx, 0x00,0x94);//VGH pump line rate 1/2H
	...
	udelay(100);
	//CKH compersation off
	lcm_dcs_write_seq_static(ctx, 0x00,0xFC);
	lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0x13);
	udelay(100);
	...
	//normal tp term 24 LPF 27
	lcm_dcs_write_seq_static(ctx, 0x00,0x82);
	lcm_dcs_write_seq_static(ctx, 0xCE,0x17,0x1A);
	udelay(100);
	...
	//Switch LPF mode
	//lcm_dcs_write_seq_static(ctx, 0x00,0xA6);//PER_DMY
	//lcm_dcs_write_seq_static(ctx, 0xCE,0x03,0x16,0x01);

	//lcm_dcs_write_seq_static(ctx, 0x00,0xB6);//POS_DMY
	//lcm_dcs_write_seq_static(ctx, 0xCE,0x03,0x16,0x01);
	...
	//lcm_dcs_write_seq_static(ctx, 0xC0,0x1A);
...
/*Just for suspend*/
static int handle_lcm_ldo(bool en)
{
	if(g_lcm == NULL){
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	if (remote_node != dev->of_node) {
		pr_info("%s/%d + %s - %s skip probe due to not current lcm\n", __func__, __LINE__, remote_node, dev->of_node);
		return -ENODEV;
	}
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "focaltech,ft8725,vdo", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-focaltech-ft8725-vdo-txd-120hz_6382",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("FT8725 VDO LCD Panel Driver");
