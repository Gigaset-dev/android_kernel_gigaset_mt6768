...
//prize add by lipenpeng 20220813 start   //-------> 4: close LCD RESET
	...
	if (IS_ERR(ctx->reset_gpio)) {
		...
		lcm_panel_bias_disable();//-------> 3: close ?ид5V
	}
...
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip,"ili7807s-gms");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "truly,ili7807s,vdo-boe-txd-gms", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-truly-ili7807s-vdo-boe-txd-gms",
		.owner = THIS_MODULE,
