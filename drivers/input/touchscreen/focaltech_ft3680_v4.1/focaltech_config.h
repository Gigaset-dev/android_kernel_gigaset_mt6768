 ...
 */
#define FTS_UPGRADE_FW_FILE                     "include/firmware/FT368x_Ref_V03_D01_20230411_app.i"

/*
 * if FTS_GET_MODULE_NUM >= 2, fw corrsponding with FTS_VENDOR_ID2
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_FILE                    "include/firmware/FT368x_Ref_V03_D01_20230411_app.i"

/*
 * if FTS_GET_MODULE_NUM >= 3, fw corrsponding with FTS_VENDOR_ID3
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_FILE                    "include/firmware/FT368x_Ref_V03_D01_20230411_app.i"
