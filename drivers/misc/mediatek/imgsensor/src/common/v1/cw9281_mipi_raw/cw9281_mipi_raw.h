 ...
 ****************************************************************************/
#ifndef __CW9281_MIPI_RAW_H
#define __CW9281_MIPI_RAW_H
...
// #define IMGSENSOR_READ_ID  (0x21)

#define GPIO_EXPANDER_WRITE_ID  (0x82)
#define GPIO_EXPANDER_READ_ID   (0x83)
