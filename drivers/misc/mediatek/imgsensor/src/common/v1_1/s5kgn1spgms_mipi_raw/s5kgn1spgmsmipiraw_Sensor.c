...
#include "s5kgn1spgmsmipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGN1SPGMS_SENSOR_ID, //Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	...
	.slim_video = {
		.pclk = 1459200000,	 /* record different mode's pclk */
		.linelength = 8000,	 /* record different mode's linelength */
		.framelength = 6016, /* record different mode's framelength */
		.startx = 0,
		.starty = 0,			   /* record different mode's starty of grabwindow */
...
static kal_uint32 s5kgn1spgms_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
								  ...
								  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		if (imgsensor.sensor_mode == IMGSENSOR_MODE_CAPTURE)
			s5kgn1spgms_awb_gain((struct SET_SENSOR_AWB_GAIN *) feature_para);
...
{
	LOG_INF("S5KGN1SPGMS_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /*	S5KGN1SPGMS_MIPI_RAW_SensorInit	*/
