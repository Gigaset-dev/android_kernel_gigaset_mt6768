...
//drv  huangjwu for node start
static struct aw22xxx * g_aw22xxx = NULL;
//drv  huangjwu for node end
/******************************************************
 *
...
static char *aw22xxx_fw_name = "aw221xx_fw.bin";
static const char *aw22xxx_cfg_name[] = {
    "aw22xxx_cfg_led_off.bin", //close 
    "aw22xxx_cfg_led_on.bin",  //test 8804
	"aw22xxx_cfg_led_blink.bin", 
	"aw22xxx_cfg_led_breath.bin",
	"aw22xxx_cfg_led_SOS_White.bin",
	"aw22xxx_led_running.bin",
	//audio demo
	"aw22xxx_cfg_audio_Demo_AllLedPro.bin",//duocai
	"aw22xxx_cfg_audio_Demo_AllLedPro_Pure.bin",//dancai
	"aw22xxx_cfg_audio_Demo_DoubleDir.bin",//duichenshang
	"aw22xxx_cfg_audio_Demo_DoubleDirAnti.bin",//duichenxia
	"aw22xxx_cfg_audio_Demo_Single.bin",//sun
	"aw22xxx_cfg_audio_Demo_SingleDirAnti.bin",//ni
	//audio??
	"aw22xxx_cfg_audio_AllLedPro.bin",//duocai
	"aw22xxx_cfg_audio_AllLedPro_Pure.bin",//dancai
	"aw22xxx_cfg_audio_DoubleDir.bin",//duichenshang
	"aw22xxx_cfg_audio_DoubleDirAnti.bin",//duichenxia
	"aw22xxx_cfg_audio_Single.bin",//sun
	"aw22xxx_cfg_audio_SingleDirAnti.bin",//ni
	//audio??
    "aw22xxx_cfg_audio_duichen.bin",  //duicheng
	"aw22xxx_cfg_audio_duichenxia.bin",  //duicheng
    "aw22xxx_cfg_audio_sunshizhen.bin",  //sunshizhen
	"aw22xxx_cfg_audio_nishizhen.bin",//nishizhen
	"aw22xxx_cfg_audio_duocai.bin",  //duocai
	"aw22xxx_cfg_audio_dancai.bin",//dancai

	//充电特效
	"aw22xxx_cfg_led_charge_Red_0.bin",
	"aw22xxx_cfg_led_charge_Red_1.bin",
	"aw22xxx_cfg_led_charge_Red_2.bin",
	"aw22xxx_cfg_led_charge_Bule_3.bin",
	"aw22xxx_cfg_led_charge_Bule_4.bin",
	"aw22xxx_cfg_led_charge_Bule_5.bin",
	"aw22xxx_cfg_led_charge_Bule_6.bin",
	"aw22xxx_cfg_led_charge_Bule_7.bin",
	"aw22xxx_cfg_led_charge_Bule_8.bin",
	"aw22xxx_cfg_led_charge_Green_8.bin",
	"aw22xxx_cfg_led_charge_Green_9.bin",
	//呼吸特效
	"aw22xxx_cfg_led_breath_Bule.bin",
	"aw22xxx_cfg_led_breath_Green.bin",
	"aw22xxx_cfg_led_breath_Red.bin",
	
	"aw22xxx_cfg_led_breath_Bamboo_Green.bin",
	"aw22xxx_cfg_led_breath_Classic_Blue.bin",
	"aw22xxx_cfg_led_breath_Elegant_Purple.bin",
	"aw22xxx_cfg_led_breath_Jade_White.bin",
	"aw22xxx_cfg_led_breath_Maple_Leaf_Red.bin",
	"aw22xxx_cfg_led_breath_Pale_Blue.bin",
	"aw22xxx_cfg_led_breath_Rainbow.bin",
	"aw22xxx_cfg_led_breath_Vitality_Orange.bin",
	"aw22xxx_cfg_led_breath_Wheat_Field_Yellow.bin",
	//快闪特效
	"aw22xxx_cfg_led_Flash_Bule.bin",
	"aw22xxx_cfg_led_Flash_Cyan.bin",
	"aw22xxx_cfg_led_Flash_Green.bin",
	"aw22xxx_cfg_led_Flash_Origin.bin",
	"aw22xxx_cfg_led_Flash_Purple.bin",
	"aw22xxx_cfg_led_Flash_Rainbow.bin",
	"aw22xxx_cfg_led_Flash_Red.bin",
	"aw22xxx_cfg_led_Flash_White.bin",
	"aw22xxx_cfg_led_Flash_Yellow.bin",
	
	"aw22xxx_cfg_led_Flash_Bamboo_Green.bin",
	"aw22xxx_cfg_led_Flash_Classic_Blue.bin",
	"aw22xxx_cfg_led_Flash_Elegant_Purple.bin",
	"aw22xxx_cfg_led_Flash_Jade_White.bin",
	"aw22xxx_cfg_led_Flash_Maple_Leaf_Red.bin",
	"aw22xxx_cfg_led_Flash_Pale_Blue.bin",
	"aw22xxx_cfg_led_Flash_Rainbow.bin",
	"aw22xxx_cfg_led_Flash_Vitality_Orange.bin",
	"aw22xxx_cfg_led_Flash_Wheat_Field_Yellow.bin",
	//慢闪特效
	"aw22xxx_cfg_led_SlowFlash_Bule.bin",
	"aw22xxx_cfg_led_SlowFlash_Cyan.bin",
	"aw22xxx_cfg_led_SlowFlash_Green.bin",
	"aw22xxx_cfg_led_SlowFlash_Origin.bin",
	"aw22xxx_cfg_led_SlowFlash_Purple.bin",
	"aw22xxx_cfg_led_SlowFlash_Rainbow.bin",
	"aw22xxx_cfg_led_SlowFlash_Red.bin",
	"aw22xxx_cfg_led_SlowFlash_White.bin",
	"aw22xxx_cfg_led_SlowFlash_Yellow.bin",
	"aw22xxx_cfg_led_SlowFlash_Bamboo_Green.bin",
	"aw22xxx_cfg_led_SlowFlash_Classic_Blue.bin",
	"aw22xxx_cfg_led_SlowFlash_Elegant_Purple.bin",
	"aw22xxx_cfg_led_SlowFlash_Jade_White.bin",
	"aw22xxx_cfg_led_SlowFlash_Maple_Leaf_Red.bin",
	"aw22xxx_cfg_led_SlowFlash_Pale_Blue.bin",
	"aw22xxx_cfg_led_SlowFlash_Rainbow.bin",
	"aw22xxx_cfg_led_SlowFlash_Vitality_Orange.bin",
	"aw22xxx_cfg_led_SlowFlash_Wheat_Field_Yellow.bin",
	//全亮 demo
	"aw22xxx_cfg_ledon_Bamboo_Green.bin",
	"aw22xxx_cfg_ledon_Classic_Blue.bin",
	"aw22xxx_cfg_ledon_Elegant_Purple.bin",
	"aw22xxx_cfg_ledon_Jade_White.bin",
	"aw22xxx_cfg_ledon_Maple_Leaf_Red.bin",
	"aw22xxx_cfg_ledon_Pale_Blue.bin",
	"aw22xxx_cfg_ledon_Rainbow.bin",
	"aw22xxx_cfg_ledon_Vitality_Orange.bin",
	"aw22xxx_cfg_ledon_Wheat_Field_Yellow.bin",
};
...
static int aw22xxx_cfg_update(struct aw22xxx *aw22xxx)
{
    ...
    if(aw22xxx->effect < (ARRAY_SIZE(aw22xxx_cfg_name))) {
                ...
                char *buf)
{
    ...
    for(i=0; i<ARRAY_SIZE(aw22xxx_cfg_name); i++) {
...
//drv huangjiwu for node start
static ssize_t effect_store(struct class *class, struct class_attribute *attr,	const char *buf, size_t count)
{

	int rc;
	unsigned int val = 0;
	struct aw22xxx *aw22xxx = g_aw22xxx;
	if(aw22xxx == NULL){
		pr_err("%s, aw22xxx is null.\n", __func__);
		return count;
	}
	rc = kstrtouint(buf, 10, &val);
	if (rc < 0)
		return rc;
	if (((val >= ARRAY_SIZE(aw22xxx_cfg_name))) || (val < 0)) {
		pr_err("%s, store effect num error %d.\n", __func__,val);
		return -EINVAL;
	}
	//val = 1;
	if(val){
//		aw22xxx_hw_enable(aw22xxx,val);
	}
	aw22xxx->cfg = 1;
	aw22xxx->effect = val;
...
static ssize_t effect_show(struct class* class,struct class_attribute *attr, char* buf)
{
	unsigned int i;
    ssize_t len = 0;
    struct aw22xxx *aw22xxx = g_aw22xxx;
    ...
    len += snprintf(buf+len, PAGE_SIZE-len, "curr_cfg = %s\n", aw22xxx_cfg_name[aw22xxx->effect]);
    len += snprintf(buf+len, PAGE_SIZE-len, "effect = 0x%02x\n", aw22xxx->effect);
    return len;
}


static ssize_t str_effect_store(struct class *class, struct class_attribute *attr,	const char *buf, size_t count)
{
	//int rc;
	int i;
	//unsigned int val = 0;
	...
	for(i = 0; i < ARRAY_SIZE(aw22xxx_cfg_name); i++ )
	{
		//pr_info("%s, buff_%s_%s\n", __func__, buf,aw22xxx_cfg_name[i]);
		if(strcmp(buf, aw22xxx_cfg_name[i]) == 0)
		{
			break;
		}
	}
	if(( i >= ARRAY_SIZE(aw22xxx_cfg_name))|| i < 0)
	{
		i = 0;
		//pr_info("%s, i = %d\n", __func__, i);
	}
	...
	if( i == 0)
	{	
		//aw22xxx->cdev.brightness = 0;
		aw22xxx_chip_enable(aw22xxx, false);
	}else
	{
		aw22xxx_chip_enable(aw22xxx, true);
		//aw22xxx->cdev.brightness = 128;
	}
	pr_info("%s, line%d,val = %d,buf=%s\n", __func__, __LINE__, i,buf);
	schedule_work(&aw22xxx->cfg_work);
	return count;
}
static ssize_t str_effect_show(struct class* class,struct class_attribute *attr, char* buf)
{
	unsigned int i;
    ssize_t len = 0;
    struct aw22xxx *aw22xxx = g_aw22xxx;
...
static ssize_t aw22xxx_imax_class_store(struct class* class, struct class_attribute *attr,
                const char* buf, size_t len)
{
    unsigned int databuf[1];
   // struct led_classdev *led_cdev = dev_get_drvdata(dev);
...
static ssize_t aw22xxx_imax_class_show(struct class* class,struct class_attribute *attr, char* buf)
{
    ssize_t len = 0;
    unsigned int i;
   // struct led_classdev *led_cdev = dev_get_drvdata(dev);
...
static struct class * aw22xxx_class;

static struct class_attribute aw22xxx_class_attrs[] = {
	__ATTR(effect, S_IRUGO | S_IWUSR, effect_show, effect_store),
	__ATTR(str_effect, S_IRUGO | S_IWUSR, str_effect_show, str_effect_store),
	__ATTR(imax, S_IRUGO | S_IWUSR, aw22xxx_imax_class_show, aw22xxx_imax_class_store),
	__ATTR_NULL,
};

static int aw22xxx_sysfs_create(void)
{
	int i = 0,ret = 0;
	
	aw22xxx_class = class_create(THIS_MODULE, "aw22xxx_led");
	if (IS_ERR(aw22xxx_class))
		return PTR_ERR(aw22xxx_class);
	for (i = 0; aw22xxx_class_attrs[i].attr.name; i++) {
		ret = class_create_file(aw22xxx_class,&aw22xxx_class_attrs[i]);
		if (ret < 0)
		{
			pr_err("aw22xxx_sysfs_create error !!\n");
			return ret;
		}
	}
	return ret;
...
static void  aw22xxx_sysfs_destroy(void)
{
	int i = 0;

	for (i = 0; aw22xxx_class_attrs[i].attr.name; i++)
		class_remove_file(aw22xxx_class, &aw22xxx_class_attrs[i]);
	
	class_destroy(aw22xxx_class);

}

//drv huangjiwu for  node end
